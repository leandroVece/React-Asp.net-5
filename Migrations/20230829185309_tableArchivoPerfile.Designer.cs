...
namespace Cadeteria.Migrations
{
    ...
    [Migration("20230829185309_tableArchivoPerfile")]
    partial class tableArchivoPerfile
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cadeteria.Models.Archivo", b =>
                {
                    ...
                    b.Property<Guid>("articulolForeiKey")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("articulolForeiKey");

                    b.ToTable("archivo", (string)null);
                });

            modelBuilder.Entity("Cadeteria.Models.ArchivoPerfil", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("perfilForeiKey")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("perfilForeiKey")
                        .IsUnique();

                    b.ToTable("archivoPerfil", (string)null);
                });
            ...
            modelBuilder.Entity("Cadeteria.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            password = "$2a$11$y7soHPETFsMMOPlU1xPlWuci5eoqeEFGDS/tBuU5alPjcxhyxibnC",
                        ...
                        new
                        {
                            ...
                            password = "$2a$11$AdC3TV.5sTx84zEdPZ54l.XEwNcu9.xrxtMLP3De.uCkrhRXJiIFe",
                        ...
                        new
                        {
                            ...
                            password = "$2a$11$Hs/JCq/2cYw.9u/ke/ggYexEWWV4sllSG8LkZoaHRHU00raCodsAW",
                        ...
                        new
                        {
                            ...
                            password = "$2a$11$3mHKnLATEEr1FtF6qUEAeevei/DyUnKgKKz5oap5gECol8YBZDAla",
                        ...
                        new
                        {
                            ...
                            password = "$2a$11$8.Ib.2sBFqSdTRrNOqRkbOQxPVS0pp5HDsKHcfXQgPC5uILWxSr/6",
                            rolForeikey = new Guid("f0601b48-a878-4fb5-a767-3f1340b8c0d8"),
                            userName = "cliente01"
                        },
                        new
                        {
                            ...
                            password = "$2a$11$lBBdyChOPoJNhZS.Icc8/eX9.J/41U1LP/Drcjj41Qi5RwZe.IP3m",
                            rolForeikey = new Guid("f0601b48-a878-4fb5-a767-3f1340b8c0d8"),
                            userName = "cliente2"
                        },
                        new
                        {
                            ...
                            password = "$2a$11$VMZQIB/46P0p3YDtjwwfau1wAOg1NIXTv5GA0Rw.r9IhUNBYE8Wb.",
                            rolForeikey = new Guid("f0601b48-a878-4fb5-a767-3f1340b8c0d8"),
                            userName = "cliente3"
                        },
                        new
                        {
                            ...
                            password = "$2a$11$YmyXY1F4gh2174PholhDVu1069/n5u0HDWzwgh9ozmYt.138psCdu",
                            rolForeikey = new Guid("f0601b48-a878-4fb5-a767-3f1340b8c0d8"),
                            userName = "cliente02"
                        },
                        new
                        {
                            ...
                            password = "$2a$11$hlqqrNAUYg.Eu7N.3V9z5u1q.PO1MjDT2fJ44mL9SXQdnOFTSRyGG",
                            rolForeikey = new Guid("f0601b48-a878-4fb5-a767-3f1340b8c0d8"),
                            userName = "cliente03"
                        },
                        new
                        {
                            ...
                            password = "$2a$11$4b2zA5n2t6Kw/zc9fogvouz.lTdX.PeVC23SSoOgiIUkG8RwiFWfa",
                            rolForeikey = new Guid("f0601b48-a878-4fb5-a767-3f1340b8c0d8"),
                            userName = "cadete2"
                        });
                });
            ...
            modelBuilder.Entity("Cadeteria.Models.Archivo", b =>
                {
                    b.HasOne("Cadeteria.Models.Articulo", "articulo")
                        .WithMany("archivos")
                        .HasForeignKey("articulolForeiKey")
            ...
            modelBuilder.Entity("Cadeteria.Models.ArchivoPerfil", b =>
                {
                    b.HasOne("Cadeteria.Models.Profile", "perfil")
                        .WithOne("archivo")
                        .HasForeignKey("Cadeteria.Models.ArchivoPerfil", "perfilForeiKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
